...
/**
 * ServiceLocator class to get reference to resource like EJB, JMS, Datasource
 * etc. This is singleton class and caches resources.
 *
 * @author rk903
 */
public class ServiceLocator {
     ...
     * @return PropertyUtil
     *
     * public static Properties getClientProperty() throws I2B2Exception { if
     * (clientProperties == null) { clientProperties =
     * getProperties(CLIENT_PROPERTY_CONFIG_LOCATION); }
     *
     ...
     * @throws I2B2Exception
     *
     * public static Properties getProperties(String propFileName) throws
     * I2B2Exception { PropertiesFactoryBean pfb = new PropertiesFactoryBean();
     * pfb.setLocation(new ClassPathResource(propFileName));
     *
     * Properties props = null;
     *
     * try { pfb.afterPropertiesSet(); props = (Properties) pfb.getObject(); }
     * catch (IOException ioEx) { throw new I2B2Exception("IOException " +
